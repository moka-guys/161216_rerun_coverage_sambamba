...
class Redo_coverage(object):
    ...
    def __init__(self):
        ...
        self.list_of_bams="/home/aled/Documents/redo_coverage/sambamba_coverage/dnanexus_run_single_app/all_bams.txt"
        #output file
        self.shellscript="/home/aled/Documents/redo_coverage/sambamba_coverage/dnanexus_run_single_app/re_do.sh"
        #empty lists
        self.templist=[]
        self.list=[]
        ...
        self.app="Workflows/chanjo_sambamba_coverage"
        self.output_project="161216_rerun_coverage_sambamba"
        #set the environment
        self.initiate = "#!/bin/bash\nsource /etc/profile.d/dnanexus.environment.sh.off\n"
        # define where the project is
        self.base_command = "dx run "+self.app_project+self.app+" -y"
        # each stage input
        self.arg1 = " -istage-F19xp0j0jy1qgbG364kz8qzK.bamfile=NGS_runs:"
        self.arg2 = " -istage-F19xp0j0jy1qgbG364kz8qzK.bam_index=NGS_runs:"
        # where the output file are going
        self.arg5 = " --dest="+self.output_project
